<?php
    ...
    $inserirProblema = mysql_query("INSERT INTO Atas_Problemas VALUES('','$id_ata','$cidade','$grupo','$problema','$Classificacao_Problema','$acao','$status','$data_conclusao','$responsavel')");        
?>
<!DOCTYPE html>
<html>
    <head>
